...
#define CONSTRUCTION_CHATEAU1  0
#define CONSTRUCTION_CHATEAU2  1
#define CONSTRUCTION_ATELIER1 2
#define CONSTRUCTION_ATELIER2 3
#define CONSTRUCTION_FERME     4
#define CONSTRUCTION_TOUR    5
